...
public class GameBoard {
    ...
    public Boolean serialise(String StateName, boolean overwrite) {
        ...
        String check = db.getGameState(StateName);
        if (check == null) {
            db.insertGameState(this.username, StateName, sb.toString());
            return true;
        }
        else if (overwrite) {
            db.updateGameState(this.username, StateName, sb.toString());
        }
        return false;
    }

    public void deserialise(String StateName) {
        String state = db.getGameState(StateName);
